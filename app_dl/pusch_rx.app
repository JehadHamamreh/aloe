...
modules:
{
	...
	idft:
	{
		...
		mopts=100;
		instances=1; /* to be replaces by 12 or 14 with additional mux/demux */
		variables=({name="direction";value=1;},{name="mirror";value=0;},{name="normalize";value=1;},
			{name="dft_size";value=69;},{name="psd";value=0},{name="out_db";value=0}
		);
	};
