...
modules:
{
	...
	pbch_tx:
	{
		include="../app_dl/pbch_tx.app";	
	};
	
	pcfich_tx:
	{
		include="../app_dl/pcfich_tx.app";	
	};

	pdcch_tx:
	{
		include="../app_dl/pdcch_tx.app";	
	};
	
	pdsch_tx:
	{
		include="../app_dl/pdsch_tx.app";	
	};
